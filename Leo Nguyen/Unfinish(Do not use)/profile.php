    ...
    <div class="container">
        ...
        <div class="profile-section">
            ...
            <div class="profile-details">
                ...
                <input type="email" id="email" name="email" value="<?php echo maskEmail($user_data['email']); ?>" readonly>
            </div>
            <div class="profile-details">
                <label for="password">Current Password</label>
                <input type="password" id="password" name="password" value="<?php echo maskPassword($user_data['password']); ?>" readonly>
            </div>
            <div class="profile-details">
